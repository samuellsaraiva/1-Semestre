...
- 5. Refaça o programa anterior, acrescente a função menu que não recebe nada, mostra
 um menu com as opções do programa e retorna a opção escolhida pelo usuário. 
A função principal vai coordenar todo o processamento, ou seja, 
chama a função menu e depois chama uma das duas funções (soma ou subtrai). ----- '''
def soma(a, b):                         # Definição das funções.
    return a + b
def subtrai(a, b):
    return a - b
